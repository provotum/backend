...
public class GetResultResponse extends AResponse {
    ...
    public GetResultResponse(String id, Status status, String message, BigInteger yes, BigInteger no, BigInteger total, BigInteger invalid) {
        super(id, status, message);

        votes.put("yes", yes);
        votes.put("no", no);
        votes.put("total", total);
        votes.put("invalid", invalid);
    }

    public GetResultResponse(Status status, String message, BigInteger yes, BigInteger no, BigInteger total, BigInteger invalid) {
